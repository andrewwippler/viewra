...
import type {
  ...
  InternalApiHandlersListEnrichmentQueueResponse,
  InternalApiHandlersPipelineStatusResponse,
...
export type postApiEnrichmentBulkEnqueueResponseError = (
  postApiEnrichmentBulkEnqueueResponse400 | postApiEnrichmentBulkEnqueueResponse500
) & {
  headers: Headers
}

export type postApiEnrichmentBulkEnqueueResponse =
  postApiEnrichmentBulkEnqueueResponseSuccess | postApiEnrichmentBulkEnqueueResponseError
...
export type postApiEnrichmentEnqueueResponseError = (
  postApiEnrichmentEnqueueResponse400 | postApiEnrichmentEnqueueResponse500
) & {
  headers: Headers
}

export type postApiEnrichmentEnqueueResponse =
  postApiEnrichmentEnqueueResponseSuccess | postApiEnrichmentEnqueueResponseError
...
/**
 * Pauses all enrichment workers. In-flight jobs complete naturally.
 * @summary Pause enrichment pipeline
 */
export type postApiEnrichmentPauseResponse200 = {
  data: InternalApiHandlersPipelineStatusResponse
  status: 200
}

export type postApiEnrichmentPauseResponseSuccess = postApiEnrichmentPauseResponse200 & {
  headers: Headers
}
export type postApiEnrichmentPauseResponse = postApiEnrichmentPauseResponseSuccess

export const getPostApiEnrichmentPauseUrl = () => {
  return `/api/enrichment/pause`
}

export const postApiEnrichmentPause = async (
  options?: RequestInit
): Promise<postApiEnrichmentPauseResponse> => {
  return customInstance<postApiEnrichmentPauseResponse>(getPostApiEnrichmentPauseUrl(), {
    ...options,
    method: 'POST',
  })
}

export const getPostApiEnrichmentPauseMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postApiEnrichmentPause>>,
    TError,
    void,
    TContext
  >
  ...
  TContext
> => {
  const mutationKey = ['postApiEnrichmentPause']
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return postApiEnrichmentPause(requestOptions)
  }

  return { mutationFn, ...mutationOptions }
}

export type PostApiEnrichmentPauseMutationResult = NonNullable<
  Awaited<ReturnType<typeof postApiEnrichmentPause>>
>

export type PostApiEnrichmentPauseMutationError = unknown

/**
 * @summary Pause enrichment pipeline
 */
export const usePostApiEnrichmentPause = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof postApiEnrichmentPause>>,
      TError,
  ...
  TContext
> => {
  const mutationOptions = getPostApiEnrichmentPauseMutationOptions(options)
...
export type postApiEnrichmentPrioritizeResponseError = (
  postApiEnrichmentPrioritizeResponse400 | postApiEnrichmentPrioritizeResponse500
) & {
  headers: Headers
}

export type postApiEnrichmentPrioritizeResponse =
  postApiEnrichmentPrioritizeResponseSuccess | postApiEnrichmentPrioritizeResponseError
...
/**
 * Returns enrichment queue items with optional status filter, paginated
 * @summary List enrichment queue items
 */
export type getApiEnrichmentQueueResponse200 = {
  data: InternalApiHandlersListEnrichmentQueueResponse
  status: 200
}

export type getApiEnrichmentQueueResponse500 = {
  data: InternalApiHandlersAPIError
  status: 500
}

export type getApiEnrichmentQueueResponseSuccess = getApiEnrichmentQueueResponse200 & {
  headers: Headers
}
export type getApiEnrichmentQueueResponseError = getApiEnrichmentQueueResponse500 & {
  headers: Headers
}

export type getApiEnrichmentQueueResponse =
  getApiEnrichmentQueueResponseSuccess | getApiEnrichmentQueueResponseError

export const getGetApiEnrichmentQueueUrl = (params?: GetApiEnrichmentQueueParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/enrichment/queue?${stringifiedParams}`
    : `/api/enrichment/queue`
}

export const getApiEnrichmentQueue = async (
  params?: GetApiEnrichmentQueueParams,
  options?: RequestInit
): Promise<getApiEnrichmentQueueResponse> => {
  return customInstance<getApiEnrichmentQueueResponse>(getGetApiEnrichmentQueueUrl(params), {
    ...options,
    method: 'GET',
  })
}

export const getGetApiEnrichmentQueueQueryKey = (params?: GetApiEnrichmentQueueParams) => {
  return [`/api/enrichment/queue`, ...(params ? [params] : [])] as const
}

export const getGetApiEnrichmentQueueQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiEnrichmentQueue>>,
  TError = InternalApiHandlersAPIError,
>(
  params?: GetApiEnrichmentQueueParams,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiEnrichmentQueue>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  }
) => {
  ...
  const queryKey = queryOptions?.queryKey ?? getGetApiEnrichmentQueueQueryKey(params)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiEnrichmentQueue>>> = ({ signal }) =>
    getApiEnrichmentQueue(params, { signal, ...requestOptions })

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getApiEnrichmentQueue>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiEnrichmentQueueQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiEnrichmentQueue>>
>
export type GetApiEnrichmentQueueQueryError = InternalApiHandlersAPIError

export function useGetApiEnrichmentQueue<
  TData = Awaited<ReturnType<typeof getApiEnrichmentQueue>>,
  TError = InternalApiHandlersAPIError,
>(
  params: undefined | GetApiEnrichmentQueueParams,
  options: {
    query: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiEnrichmentQueue>>, TError, TData>
    > &
...
>(
  ...
  const queryOptions = getGetApiEnrichmentQueueQueryOptions(params, options)
...
/**
 * Resumes enrichment workers after a pause.
 * @summary Resume enrichment pipeline
 */
export type postApiEnrichmentResumeResponse200 = {
  data: InternalApiHandlersPipelineStatusResponse
  status: 200
}

export type postApiEnrichmentResumeResponseSuccess = postApiEnrichmentResumeResponse200 & {
  headers: Headers
}
export type postApiEnrichmentResumeResponse = postApiEnrichmentResumeResponseSuccess

export const getPostApiEnrichmentResumeUrl = () => {
  return `/api/enrichment/resume`
}

export const postApiEnrichmentResume = async (
  options?: RequestInit
): Promise<postApiEnrichmentResumeResponse> => {
  return customInstance<postApiEnrichmentResumeResponse>(getPostApiEnrichmentResumeUrl(), {
    ...options,
    method: 'POST',
  })
}

export const getPostApiEnrichmentResumeMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postApiEnrichmentResume>>,
    TError,
    void,
    TContext
  >
  ...
  TContext
> => {
  const mutationKey = ['postApiEnrichmentResume']
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return postApiEnrichmentResume(requestOptions)
  }

  return { mutationFn, ...mutationOptions }
}

export type PostApiEnrichmentResumeMutationResult = NonNullable<
  Awaited<ReturnType<typeof postApiEnrichmentResume>>
>

export type PostApiEnrichmentResumeMutationError = unknown

/**
 * @summary Resume enrichment pipeline
 */
export const usePostApiEnrichmentResume = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof postApiEnrichmentResume>>,
      TError,
  ...
  TContext
> => {
  const mutationOptions = getPostApiEnrichmentResumeMutationOptions(options)
...
export type postApiEnrichmentRetryResponseError = (
  postApiEnrichmentRetryResponse400 | postApiEnrichmentRetryResponse500
) & {
  headers: Headers
}

export type postApiEnrichmentRetryResponse =
  postApiEnrichmentRetryResponseSuccess | postApiEnrichmentRetryResponseError
...
export type getApiEnrichmentStatsResponse =
  getApiEnrichmentStatsResponseSuccess | getApiEnrichmentStatsResponseError
...
/**
 * Returns whether the enrichment pipeline is currently paused
 * @summary Get enrichment pipeline status
 */
export type getApiEnrichmentStatusResponse200 = {
  data: InternalApiHandlersPipelineStatusResponse
  status: 200
}

export type getApiEnrichmentStatusResponseSuccess = getApiEnrichmentStatusResponse200 & {
  headers: Headers
}
export type getApiEnrichmentStatusResponse = getApiEnrichmentStatusResponseSuccess

export const getGetApiEnrichmentStatusUrl = () => {
  return `/api/enrichment/status`
}

export const getApiEnrichmentStatus = async (
  options?: RequestInit
): Promise<getApiEnrichmentStatusResponse> => {
  return customInstance<getApiEnrichmentStatusResponse>(getGetApiEnrichmentStatusUrl(), {
    ...options,
    method: 'GET',
  })
}

export const getGetApiEnrichmentStatusQueryKey = () => {
  return [`/api/enrichment/status`] as const
}

export const getGetApiEnrichmentStatusQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiEnrichmentStatus>>,
  TError = unknown,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getApiEnrichmentStatus>>, TError, TData>
  >
  request?: SecondParameter<typeof customInstance>
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetApiEnrichmentStatusQueryKey()

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiEnrichmentStatus>>> = ({ signal }) =>
    getApiEnrichmentStatus({ signal, ...requestOptions })

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getApiEnrichmentStatus>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiEnrichmentStatusQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiEnrichmentStatus>>
>
export type GetApiEnrichmentStatusQueryError = unknown

export function useGetApiEnrichmentStatus<
  TData = Awaited<ReturnType<typeof getApiEnrichmentStatus>>,
  TError = unknown,
>(
  options: {
...
>(
  ...
  const queryOptions = getGetApiEnrichmentStatusQueryOptions(options)
...
export type getApiLibrariesIdEnrichmentFailuresResponseError = (
  getApiLibrariesIdEnrichmentFailuresResponse400 | getApiLibrariesIdEnrichmentFailuresResponse500
) & {
  headers: Headers
}
...
export type getApiLibrariesIdEnrichmentProgressResponseError = (
  getApiLibrariesIdEnrichmentProgressResponse400 | getApiLibrariesIdEnrichmentProgressResponse500
) & {
  headers: Headers
}
...
export type getApiLibrariesIdEnrichmentStreamResponse =
  getApiLibrariesIdEnrichmentStreamResponseSuccess | getApiLibrariesIdEnrichmentStreamResponseError
