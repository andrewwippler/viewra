...
import type {
  GetApiMediaIdHlsHeartbeatParams,
...
/**
 * Lightweight endpoint to prevent idle session timeout during pauses
 * @summary Keep transcode session alive
 */
export type getApiMediaIdHlsHeartbeatResponse200 = {
  data: void
  status: 200
}

export type getApiMediaIdHlsHeartbeatResponse400 = {
  data: InternalApiHandlersAPIError
  status: 400
}

export type getApiMediaIdHlsHeartbeatResponse404 = {
  data: void
  status: 404
}

export type getApiMediaIdHlsHeartbeatResponseSuccess = getApiMediaIdHlsHeartbeatResponse200 & {
  headers: Headers
}
export type getApiMediaIdHlsHeartbeatResponseError = (
  getApiMediaIdHlsHeartbeatResponse400 | getApiMediaIdHlsHeartbeatResponse404
) & {
  headers: Headers
}

export type getApiMediaIdHlsHeartbeatResponse =
  getApiMediaIdHlsHeartbeatResponseSuccess | getApiMediaIdHlsHeartbeatResponseError

export const getGetApiMediaIdHlsHeartbeatUrl = (
  id: number,
  params: GetApiMediaIdHlsHeartbeatParams
) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/media/${id}/hls/heartbeat?${stringifiedParams}`
    : `/api/media/${id}/hls/heartbeat`
}

export const getApiMediaIdHlsHeartbeat = async (
  id: number,
  params: GetApiMediaIdHlsHeartbeatParams,
  options?: RequestInit
): Promise<getApiMediaIdHlsHeartbeatResponse> => {
  return customInstance<getApiMediaIdHlsHeartbeatResponse>(
    getGetApiMediaIdHlsHeartbeatUrl(id, params),
    {
      ...options,
      method: 'GET',
    }
...
export const getGetApiMediaIdHlsHeartbeatQueryKey = (
  id?: number,
  params?: GetApiMediaIdHlsHeartbeatParams
) => {
  return [`/api/media/${id}/hls/heartbeat`, ...(params ? [params] : [])] as const
}

export const getGetApiMediaIdHlsHeartbeatQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiMediaIdHlsHeartbeat>>,
  TError = InternalApiHandlersAPIError | void,
>(
  id: number,
  params: GetApiMediaIdHlsHeartbeatParams,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getApiMediaIdHlsHeartbeat>>, TError, TData>
    >
  ...
  const queryKey = queryOptions?.queryKey ?? getGetApiMediaIdHlsHeartbeatQueryKey(id, params)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiMediaIdHlsHeartbeat>>> = ({
    signal,
  }) => getApiMediaIdHlsHeartbeat(id, params, { signal, ...requestOptions })

  return { queryKey, queryFn, enabled: !!id, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getApiMediaIdHlsHeartbeat>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiMediaIdHlsHeartbeatQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiMediaIdHlsHeartbeat>>
>
export type GetApiMediaIdHlsHeartbeatQueryError = InternalApiHandlersAPIError | void

export function useGetApiMediaIdHlsHeartbeat<
  TData = Awaited<ReturnType<typeof getApiMediaIdHlsHeartbeat>>,
  TError = InternalApiHandlersAPIError | void,
>(
  id: number,
...
>(
  ...
  const queryOptions = getGetApiMediaIdHlsHeartbeatQueryOptions(id, params, options)
...
export type getApiMediaIdHlsMasterM3u8Response =
  getApiMediaIdHlsMasterM3u8ResponseSuccess | getApiMediaIdHlsMasterM3u8ResponseError
...
export type getApiMediaIdHlsQualityFilenameResponse =
  getApiMediaIdHlsQualityFilenameResponseSuccess | getApiMediaIdHlsQualityFilenameResponseError
...
export type postApiMediaIdTranscodeResponse =
  postApiMediaIdTranscodeResponseSuccess | postApiMediaIdTranscodeResponseError
...
export type getApiMediaIdTranscodeQualityResponseError = (
  getApiMediaIdTranscodeQualityResponse404 | getApiMediaIdTranscodeQualityResponse500
) & {
  headers: Headers
}

export type getApiMediaIdTranscodeQualityResponse =
  getApiMediaIdTranscodeQualityResponseSuccess | getApiMediaIdTranscodeQualityResponseError
...
export type postApiTranscodeCleanupResponseError = (
  postApiTranscodeCleanupResponse400 | postApiTranscodeCleanupResponse500
) & {
  headers: Headers
}

export type postApiTranscodeCleanupResponse =
  postApiTranscodeCleanupResponseSuccess | postApiTranscodeCleanupResponseError
...
export type getApiTranscodeDiskUsageResponse =
  getApiTranscodeDiskUsageResponseSuccess | getApiTranscodeDiskUsageResponseError
...
export type getApiTranscodeStatsResponse =
  getApiTranscodeStatsResponseSuccess | getApiTranscodeStatsResponseError
