...
func (UnimplementedPluginProviderServer) DescribeMethods(context.Context, *Empty) (*ProviderMethodsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DescribeMethods not implemented")
}
...
func (UnimplementedPluginProviderServer) GenerateEmbeddingBatch(context.Context, *ProviderEmbeddingBatchRequest) (*ProviderEmbeddingBatchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateEmbeddingBatch not implemented")
}
