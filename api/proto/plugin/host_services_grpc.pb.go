...
const (
	...
	HostData_GetNextUnwatchedEpisodes_FullMethodName = "/viewra.plugin.v1.HostData/GetNextUnwatchedEpisodes"
)
...
type HostDataClient interface {
	...
	// the user is currently watching. Replaces the fragile plugin-based algorithm
	// that grouped by show title string and limited to 50 episodes per show.
	GetNextUnwatchedEpisodes(ctx context.Context, in *GetNextUnwatchedRequest, opts ...grpc.CallOption) (*GetNextUnwatchedResponse, error)
}
...
func (c *hostDataClient) GetNextUnwatchedEpisodes(ctx context.Context, in *GetNextUnwatchedRequest, opts ...grpc.CallOption) (*GetNextUnwatchedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetNextUnwatchedResponse)
	err := c.cc.Invoke(ctx, HostData_GetNextUnwatchedEpisodes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HostDataServer interface {
	...
	// the user is currently watching. Replaces the fragile plugin-based algorithm
	// that grouped by show title string and limited to 50 episodes per show.
	GetNextUnwatchedEpisodes(context.Context, *GetNextUnwatchedRequest) (*GetNextUnwatchedResponse, error)
...
func (UnimplementedHostDataServer) ListMediaByLibrary(context.Context, *ListMediaRequest) (*MediaDetailsList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMediaByLibrary not implemented")
}
...
func (UnimplementedHostDataServer) ListMediaByGenre(context.Context, *ListMediaByGenreRequest) (*MediaList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMediaByGenre not implemented")
}
func (UnimplementedHostDataServer) ListMediaByDirector(context.Context, *ListMediaByDirectorRequest) (*MediaList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMediaByDirector not implemented")
}
func (UnimplementedHostDataServer) GetNextUnwatchedEpisodes(context.Context, *GetNextUnwatchedRequest) (*GetNextUnwatchedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetNextUnwatchedEpisodes not implemented")
}
...
func RegisterHostDataServer(s grpc.ServiceRegistrar, srv HostDataServer) {
	// If the following call panics, it indicates UnimplementedHostDataServer was
...
func _HostData_GetNextUnwatchedEpisodes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNextUnwatchedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HostDataServer).GetNextUnwatchedEpisodes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HostData_GetNextUnwatchedEpisodes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HostDataServer).GetNextUnwatchedEpisodes(ctx, req.(*GetNextUnwatchedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HostData_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNextUnwatchedEpisodes",
			Handler:    _HostData_GetNextUnwatchedEpisodes_Handler,
		},
	},
...
func (UnimplementedHostStorageServer) GetDatabasePath(context.Context, *Empty) (*DatabasePath, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDatabasePath not implemented")
}
...
func (UnimplementedHostStorageServer) VectorStoreEmbedding(context.Context, *VectorStoreRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method VectorStoreEmbedding not implemented")
}
func (UnimplementedHostStorageServer) VectorStoreBatch(context.Context, *VectorStoreBatchRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method VectorStoreBatch not implemented")
}
...
func (UnimplementedHostStorageServer) VectorSearchText(context.Context, *VectorTextSearchRequest) (*VectorSearchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VectorSearchText not implemented")
}
...
func (UnimplementedHostStorageServer) VectorDeleteByType(context.Context, *VectorTypeQuery) (*VectorDeleteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VectorDeleteByType not implemented")
}
func (UnimplementedHostStorageServer) VectorCount(context.Context, *VectorTypeQuery) (*VectorCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VectorCount not implemented")
}
...
func RegisterHostStorageServer(s grpc.ServiceRegistrar, srv HostStorageServer) {
	// If the following call panics, it indicates UnimplementedHostStorageServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterHostUserMetadataServer(s grpc.ServiceRegistrar, srv HostUserMetadataServer) {
	// If the following call panics, it indicates UnimplementedHostUserMetadataServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedHostFileParserServer) ParseNFO(context.Context, *ParseNFORequest) (*NFOMetadata, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseNFO not implemented")
}
func (UnimplementedHostFileParserServer) ExtractEmbeddedImages(context.Context, *ExtractImagesRequest) (*ExtractImagesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExtractEmbeddedImages not implemented")
}
...
func RegisterHostFileParserServer(s grpc.ServiceRegistrar, srv HostFileParserServer) {
	// If the following call panics, it indicates UnimplementedHostFileParserServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterHostWeatherServer(s grpc.ServiceRegistrar, srv HostWeatherServer) {
	// If the following call panics, it indicates UnimplementedHostWeatherServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedHostRatingsServer) GetRatedEntityIDs(context.Context, *GetRatedEntityIDsRequest) (*EntityIDsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRatedEntityIDs not implemented")
}
func (UnimplementedHostRatingsServer) GetPositivelyRatedIDs(context.Context, *GetPositivelyRatedIDsRequest) (*EntityIDsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPositivelyRatedIDs not implemented")
}
func (UnimplementedHostRatingsServer) HasRatings(context.Context, *HasRatingsRequest) (*HasRatingsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HasRatings not implemented")
}
...
func RegisterHostRatingsServer(s grpc.ServiceRegistrar, srv HostRatingsServer) {
	// If the following call panics, it indicates UnimplementedHostRatingsServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedHostPluginsServer) SetCapabilityPreference(context.Context, *CapabilityPreferenceRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SetCapabilityPreference not implemented")
}
func (UnimplementedHostPluginsServer) ClearCapabilityPreference(context.Context, *CapabilityPreferenceRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearCapabilityPreference not implemented")
}
func (UnimplementedHostPluginsServer) GetCapabilityPreferences(context.Context, *Empty) (*CapabilityPreferencesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCapabilityPreferences not implemented")
}
...
func (UnimplementedHostPluginsServer) InvokeCapabilityStream(*CapabilityInvokeRequest, grpc.ServerStreamingServer[CapabilityInvokeResponse]) error {
	return status.Error(codes.Unimplemented, "method InvokeCapabilityStream not implemented")
}
func (UnimplementedHostPluginsServer) DescribeCapability(context.Context, *DescribeCapabilityRequest) (*DescribeCapabilityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DescribeCapability not implemented")
}
func (UnimplementedHostPluginsServer) InvokeVectorSearch(context.Context, *VectorSearchInvokeRequest) (*VectorSearchInvokeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InvokeVectorSearch not implemented")
}
...
func RegisterHostPluginsServer(s grpc.ServiceRegistrar, srv HostPluginsServer) {
	// If the following call panics, it indicates UnimplementedHostPluginsServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedHostProgressServer) ListWatchedItems(context.Context, *ListWatchedItemsRequest) (*ListWatchedItemsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListWatchedItems not implemented")
}
func (UnimplementedHostProgressServer) ListInProgressItems(context.Context, *ListInProgressItemsRequest) (*ListInProgressItemsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListInProgressItems not implemented")
}
func (UnimplementedHostProgressServer) GetWatchedEntityIDs(context.Context, *GetWatchedEntityIDsRequest) (*EntityIDsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetWatchedEntityIDs not implemented")
}
func (UnimplementedHostProgressServer) HasWatchHistory(context.Context, *HasWatchHistoryRequest) (*HasWatchHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HasWatchHistory not implemented")
}
...
func RegisterHostProgressServer(s grpc.ServiceRegistrar, srv HostProgressServer) {
	// If the following call panics, it indicates UnimplementedHostProgressServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
