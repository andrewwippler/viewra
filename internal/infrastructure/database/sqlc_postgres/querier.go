...
type Querier interface {
	...
	BulkCreatePrograms(ctx context.Context, arg BulkCreateProgramsParams) error
	...
	CreateChannel(ctx context.Context, arg CreateChannelParams) (LiveChannel, error)
	CreateChannelEPGMapping(ctx context.Context, arg CreateChannelEPGMappingParams) (LiveChannelEpgMapping, error)
	...
	CreateProgram(ctx context.Context, arg CreateProgramParams) (LiveEpgProgram, error)
	...
	DeleteChannelEPGMapping(ctx context.Context, arg DeleteChannelEPGMappingParams) error
	DeleteChannelEPGMappingsByLibrary(ctx context.Context, libraryID int64) error
	DeleteChannelsByLibrary(ctx context.Context, libraryID int64) error
	...
	DeleteOldPrograms(ctx context.Context, endTime time.Time) error
	...
	DeleteProgramsByChannel(ctx context.Context, channelID int64) error
	DeleteProgramsByLibrary(ctx context.Context, libraryID int64) error
	...
	GetChannel(ctx context.Context, id int64) (LiveChannel, error)
	GetChannelByEPGID(ctx context.Context, arg GetChannelByEPGIDParams) (LiveChannel, error)
	GetChannelEPGMapping(ctx context.Context, arg GetChannelEPGMappingParams) (LiveChannelEpgMapping, error)
	...
	GetCurrentProgram(ctx context.Context, arg GetCurrentProgramParams) (LiveEpgProgram, error)
	GetDirectorsForEntity(ctx context.Context, arg GetDirectorsForEntityParams) ([]GetDirectorsForEntityRow, error)
	GetEPGMappingForLibrary(ctx context.Context, libraryID int64) ([]GetEPGMappingForLibraryRow, error)
	...
	GetMoviesWithoutVariantGroup(ctx context.Context, libraryID int64) ([]GetMoviesWithoutVariantGroupRow, error)
	...
	GetProgram(ctx context.Context, id int64) (LiveEpgProgram, error)
	...
	GetVariantsByGroupID(ctx context.Context, variantGroupID sql.NullInt64) ([]Medium, error)
	...
	HasUserRatings(ctx context.Context, userID string) (bool, error)
	...
	ListChannelEPGMappings(ctx context.Context, libraryID int64) ([]ListChannelEPGMappingsRow, error)
	ListChannels(ctx context.Context, libraryID int64) ([]LiveChannel, error)
	...
	ListProgramsByChannel(ctx context.Context, arg ListProgramsByChannelParams) ([]LiveEpgProgram, error)
	ListProgramsByLibrary(ctx context.Context, arg ListProgramsByLibraryParams) ([]LiveEpgProgram, error)
	...
	ListRandomMovies(ctx context.Context, dollar_1 int64) ([]ListRandomMoviesRow, error)
	...
	UpdateChannelEPGMapping(ctx context.Context, arg UpdateChannelEPGMappingParams) (LiveChannelEpgMapping, error)
	...
	UpsertChannel(ctx context.Context, arg UpsertChannelParams) (LiveChannel, error)
