...
func TestParseTVEpisode(t *testing.T) {
	tests := []struct {
		...
		{
			name:            "Show code prefix with episode title (PMC - Title)",
			path:            "/media/TV Shows/Peanuts - Charlie Brown - High Quality (Complete Collection)/Charlie Brown - Peanuts Motion Comics - High Quality (Full Episodes)/PMC - The Sore Arm.mp4",
			expectedShow:    "Charlie Brown Peanuts Motion Comics High Quality (Full Episodes)",
			expectedSeason:  1,
			expectedEpisode: 1, // Default when no numbering found and not in Specials
			expectedTitle:   "The Sore Arm",
			shouldError:     false,
		},
		{
			name:            "Single-digit season with dash before episode (S9-E01. Title)",
			path:            "/media/TV Shows/Curious George/Season 9/S9-E01. Submonkey - Double-O Monkey Tracks Trouble [Nanto].mp4",
			expectedShow:    "Curious George",
			expectedSeason:  9,
			expectedEpisode: 1,
			expectedTitle:   "Submonkey - Double-O Monkey Tracks Trouble",
			shouldError:     false,
		},
		{
			name:            "Standard S02E04 with no separators before title",
			path:            "/media/TV Shows/The Abbott and Costello Show/Season 2/S02E04 Abbott and Costello in Life Insurance.mp4",
			expectedShow:    "The Abbott and Costello Show",
			expectedSeason:  2,
			expectedEpisode: 4,
			expectedTitle:   "Abbott and Costello in Life Insurance",
			shouldError:     false,
		},
		{
			name:            "Old TV format: Show - EpisodeNumber - Title (Green Acres)",
			path:            "/media/TV Shows/GreenAcresCompleteSeries/Green Acres Season 4/Green Acres Season 4/Green Acres - 096 - Eb's Romance - (TV Rip).mp4",
			expectedShow:    "Green Acres",
			expectedSeason:  4,
			expectedEpisode: 96,
			expectedTitle:   "Eb's Romance - (TV Rip)",
			shouldError:     false,
		},
		{
			name:            "Old TV format: High episode number",
			path:            "/media/TV Shows/GreenAcresCompleteSeries/Green Acres Season 6/Green Acres Season 6/Green Acres - 148 - Eb's Double Trouble - (TV Rip).mp4",
			expectedShow:    "Green Acres",
			expectedSeason:  6,
			expectedEpisode: 148,
			expectedTitle:   "Eb's Double Trouble - (TV Rip)",
			shouldError:     false,
		},
	}
